...
INSERT INTO `rex_420_xoutputfilter` VALUES 
  (2,4,0,'Beispiel_003','Alle HTML-Kommentare entfernen - ausser Conditional Comments für IE',0,'/<!--[^\\[](.|\\s)*?[^\\]]-->/','',1,1,0,'',3,'','','','0000-00-00 00:00:00','0000-00-00 00:00:00'),
  (3,4,1,'Beispiel_005','Ungeschlossene Tags schliessen (<br>, <hr>, <img>, <input>, <meta>, <base>, <basefont>, <param>, <link>, <area>)',0,'/\r\n<(br|hr|img|input|meta|base|basefont|param|link|area)\r\n+\r\n((\\s+[a-zA-Z-]+\\s*=\\s*(\"([^\"]*)\"|\'([^\']*)\'|([a-zA-Z0-9]*)))*\\s*)>\r\n/ix','<$1$2 />',1,1,0,'',3,'','','','0000-00-00 00:00:00','0000-00-00 00:00:00'),
...
INSERT INTO `rex_article` VALUES 
  (1,1,0,'Home','Home',1,'',1,1,'|',1,1377518652,1383740266,1,0,'olien','olien',0,'','','','','','','','','','','','','',''),
  (2,2,0,'Wartungsarbeiten','',0,'',0,1,'|',1,1365071764,1365072133,2,0,'olien','olien',0,'','','','','','','','','','','','','',''),
  (8,4,0,'Beispiele','Beispiele',3,'',1,1,'|',1,1383734925,1383734954,1,0,'olien','olien',0,'','','','','','','','','','','','','',''),
...
INSERT INTO `rex_file` VALUES 
  (2,0,0,'','image/jpeg','wiegen.jpg','wiegen.jpg','15138',226,223,'',1378115967,1378115967,'olien','olien',0,'','');
